...
from relay_heater import heater_on, heater_off
from relay_lampu import lampu_on, lampu_off
...
def get_request(buka,varjam,varmenit):
    ...
    url = "{}/api/v1.6/devices/{}/{}/lv".format(url, VARIABLE_LABEL_7)
